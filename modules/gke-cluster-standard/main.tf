...
resource "google_container_cluster" "cluster" {
  ...
  dynamic "secret_sync_config" {
    for_each = try(var.enable_features.secret_sync_config, null) != null ? [""] : []
    content {
      ...
      dynamic "rotation_config" {
        ...
        content {
          enabled           = try(var.enable_features.secret_sync_config.rotation_config.enabled, null)
          rotation_interval = try(var.enable_features.secret_sync_config.rotation_config.rotation_interval, null)
        }
      }
    }
  }
